...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is CPDataCenter
                   DESC

  s.homepage     = "https://github.com/CasaPassword/CPDataCenter"
  ...
  s.source       = { :git => "https://github.com/CasaPassword/CPDataCenter.git", :tag => s.version.to_s }
  ...
  s.source_files  = "CPDataCenter/CPDataCenter/**/*.{h,m}"
